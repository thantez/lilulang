...
lilu_grammarListener.prototype.exitType = function(ctx) {
	//switch (type) case int symbol.width = 4 ...
};
...
lilu_grammarListener.prototype.exitRef = function(ctx) {
	//symbol.id = ref.id
	//if scope.symbolTable.contains(symbol.id) => error
};
...
lilu_grammarListener.prototype.exitType_dcl = function(ctx) {
	//symbol.id = type_dcl.id;
	//if symbolTable.contains(symbol.id) => error else add symbol to symbol table
};
...
// Enter a parse tree produced by lilu_grammarParser#paramsExpr.
lilu_grammarListener.prototype.enterParamsExpr = function(ctx) {
};

// Exit a parse tree produced by lilu_grammarParser#paramsExpr.
lilu_grammarListener.prototype.exitParamsExpr = function(ctx) {
};


// Enter a parse tree produced by lilu_grammarParser#paramsExprCOMMA.
lilu_grammarListener.prototype.enterParamsExprCOMMA = function(ctx) {
};

// Exit a parse tree produced by lilu_grammarParser#paramsExprCOMMA.
lilu_grammarListener.prototype.exitParamsExprCOMMA = function(ctx) {
};
